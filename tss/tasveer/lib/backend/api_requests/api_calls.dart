...
class TwilioSendSMSCall {
  static Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl:
          'https://api.twilio.com/2010-04-01/Accounts/AC977f7360be8464f71de7a10a636e4754/Messages.json',
      callType: ApiCallType.POST,
      headers: {
        'Authorization':
            'Basic QUM5NzdmNzM2MGJlODQ2NGY3MWRlN2ExMGE2MzZlNDc1NDo1OGNhNmZmYjZiNzE1MjkxMjM2YjI1ODgxYWE4YjhjYQ==',
      },
      params: {
        'To': to,
        'Body': body,
