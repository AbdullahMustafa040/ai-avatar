...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFFD800);
  late Color secondary = const Color(0xFF212121);
  late Color tertiary = const Color(0xFF121212);
  late Color alternate = const Color(0xFFFF5963);
  late Color primaryText = const Color(0xFFB3B3B3);
  late Color secondaryText = const Color(0xFF535353);
