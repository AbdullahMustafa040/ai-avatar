                            ...
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: Image.asset(
                                    'assets/images/png-clipart-computer-icons-avatar-icon-design-avatar-heroes-computer-wallpaper-thumbnail-removebg-preview_1.png',
                                    fit: BoxFit.cover,
                                  ),
                                ),
                              ),
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: FutureBuilder<int>(
                        future: queryImageGenerationRecordCount(
                                ...
                                if (columnCount == 0)
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 8.0, 0.0, 0.0),
                                    child: Text(
                                      'You have not created any avatars yet. Head over to the home screen to make your own avatars.',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Nunito',
                                  ...
                                  child: PagedListView<
                                    ...
                                    builderDelegate: PagedChildBuilderDelegate<
                                      ...
                                      itemBuilder: (context, _, listViewIndex) {
                                        final listViewImageGenerationRecord =
                                            _model.pagingController!
